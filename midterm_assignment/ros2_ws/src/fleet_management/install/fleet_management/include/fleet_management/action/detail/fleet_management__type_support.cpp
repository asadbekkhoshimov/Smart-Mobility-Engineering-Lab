...
{
  new (message_memory) fleet_management::action::FleetManagement_Goal(_init);
}

void FleetManagement_Goal_fini_function(void * message_memory)
{
  auto typed_message = static_cast<fleet_management::action::FleetManagement_Goal *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember FleetManagement_Goal_message_member_array[1] = {
  {
    ...
    offsetof(fleet_management::action::FleetManagement_Goal, order),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers FleetManagement_Goal_message_members = {
  "fleet_management::action",  // message namespace
  "FleetManagement_Goal",  // message name
  1,  // number of fields
  sizeof(fleet_management::action::FleetManagement_Goal),
...
{
  return &::fleet_management::action::rosidl_typesupport_introspection_cpp::FleetManagement_Goal_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fleet_management, action, FleetManagement_Goal)() {
  return &::fleet_management::action::rosidl_typesupport_introspection_cpp::FleetManagement_Goal_message_type_support_handle;
}
...
void FleetManagement_Result_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) fleet_management::action::FleetManagement_Result(_init);
}

void FleetManagement_Result_fini_function(void * message_memory)
{
  auto typed_message = static_cast<fleet_management::action::FleetManagement_Result *>(message_memory);
  typed_message->~FleetManagement_Result();
}

size_t size_function__FleetManagement_Result__sequence(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<int32_t> *>(untyped_member);
  return member->size();
}

const void * get_const_function__FleetManagement_Result__sequence(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__FleetManagement_Result__sequence(void * untyped_member, size_t index)
{
  auto & member =
...
void resize_function__FleetManagement_Result__sequence(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<int32_t> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember FleetManagement_Result_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(fleet_management::action::FleetManagement_Result, sequence),  // bytes offset in struct
    nullptr,  // default value
    size_function__FleetManagement_Result__sequence,  // size() function pointer
    get_const_function__FleetManagement_Result__sequence,  // get_const(index) function pointer
    get_function__FleetManagement_Result__sequence,  // get(index) function pointer
    resize_function__FleetManagement_Result__sequence  // resize(index) function pointer
  }
};
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers FleetManagement_Result_message_members = {
  ...
  1,  // number of fields
  sizeof(fleet_management::action::FleetManagement_Result),
...
{
  return &::fleet_management::action::rosidl_typesupport_introspection_cpp::FleetManagement_Result_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fleet_management, action, FleetManagement_Result)() {
  return &::fleet_management::action::rosidl_typesupport_introspection_cpp::FleetManagement_Result_message_type_support_handle;
}
...
void FleetManagement_Feedback_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) fleet_management::action::FleetManagement_Feedback(_init);
}

void FleetManagement_Feedback_fini_function(void * message_memory)
{
  auto typed_message = static_cast<fleet_management::action::FleetManagement_Feedback *>(message_memory);
  typed_message->~FleetManagement_Feedback();
}

size_t size_function__FleetManagement_Feedback__partial_sequence(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<int32_t> *>(untyped_member);
  return member->size();
}

const void * get_const_function__FleetManagement_Feedback__partial_sequence(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<int32_t> *>(untyped_member);
  return &member[index];
...
void * get_function__FleetManagement_Feedback__partial_sequence(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<int32_t> *>(untyped_member);
  return &member[index];
...
void resize_function__FleetManagement_Feedback__partial_sequence(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<int32_t> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember FleetManagement_Feedback_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(fleet_management::action::FleetManagement_Feedback, partial_sequence),  // bytes offset in struct
    nullptr,  // default value
    size_function__FleetManagement_Feedback__partial_sequence,  // size() function pointer
    get_const_function__FleetManagement_Feedback__partial_sequence,  // get_const(index) function pointer
    get_function__FleetManagement_Feedback__partial_sequence,  // get(index) function pointer
    resize_function__FleetManagement_Feedback__partial_sequence  // resize(index) function pointer
  }
};
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers FleetManagement_Feedback_message_members = {
  ...
  1,  // number of fields
  sizeof(fleet_management::action::FleetManagement_Feedback),
...
{
  return &::fleet_management::action::rosidl_typesupport_introspection_cpp::FleetManagement_Feedback_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fleet_management, action, FleetManagement_Feedback)() {
  return &::fleet_management::action::rosidl_typesupport_introspection_cpp::FleetManagement_Feedback_message_type_support_handle;
}
...
void FleetManagement_SendGoal_Request_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) fleet_management::action::FleetManagement_SendGoal_Request(_init);
}

void FleetManagement_SendGoal_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<fleet_management::action::FleetManagement_SendGoal_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember FleetManagement_SendGoal_Request_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(fleet_management::action::FleetManagement_SendGoal_Request, goal_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<fleet_management::action::FleetManagement_Goal>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(fleet_management::action::FleetManagement_SendGoal_Request, goal),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers FleetManagement_SendGoal_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(fleet_management::action::FleetManagement_SendGoal_Request),
...
{
  return &::fleet_management::action::rosidl_typesupport_introspection_cpp::FleetManagement_SendGoal_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fleet_management, action, FleetManagement_SendGoal_Request)() {
  return &::fleet_management::action::rosidl_typesupport_introspection_cpp::FleetManagement_SendGoal_Request_message_type_support_handle;
}
...
void FleetManagement_SendGoal_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) fleet_management::action::FleetManagement_SendGoal_Response(_init);
}

void FleetManagement_SendGoal_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<fleet_management::action::FleetManagement_SendGoal_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember FleetManagement_SendGoal_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(fleet_management::action::FleetManagement_SendGoal_Response, accepted),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(fleet_management::action::FleetManagement_SendGoal_Response, stamp),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers FleetManagement_SendGoal_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(fleet_management::action::FleetManagement_SendGoal_Response),
...
{
  return &::fleet_management::action::rosidl_typesupport_introspection_cpp::FleetManagement_SendGoal_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fleet_management, action, FleetManagement_SendGoal_Response)() {
  return &::fleet_management::action::rosidl_typesupport_introspection_cpp::FleetManagement_SendGoal_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers FleetManagement_SendGoal_service_members = {
  "fleet_management::action",  // service namespace
  "FleetManagement_SendGoal",  // service name
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<fleet_management::action::FleetManagement_SendGoal>()
...
get_service_type_support_handle<fleet_management::action::FleetManagement_SendGoal>()
{
  ...
  auto service_type_support =
    &::fleet_management::action::rosidl_typesupport_introspection_cpp::FleetManagement_SendGoal_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fleet_management, action, FleetManagement_SendGoal)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<fleet_management::action::FleetManagement_SendGoal>();
}
...
void FleetManagement_GetResult_Request_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) fleet_management::action::FleetManagement_GetResult_Request(_init);
}

void FleetManagement_GetResult_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<fleet_management::action::FleetManagement_GetResult_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember FleetManagement_GetResult_Request_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(fleet_management::action::FleetManagement_GetResult_Request, goal_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers FleetManagement_GetResult_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(fleet_management::action::FleetManagement_GetResult_Request),
...
{
  return &::fleet_management::action::rosidl_typesupport_introspection_cpp::FleetManagement_GetResult_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fleet_management, action, FleetManagement_GetResult_Request)() {
  return &::fleet_management::action::rosidl_typesupport_introspection_cpp::FleetManagement_GetResult_Request_message_type_support_handle;
}
...
void FleetManagement_GetResult_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) fleet_management::action::FleetManagement_GetResult_Response(_init);
}

void FleetManagement_GetResult_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<fleet_management::action::FleetManagement_GetResult_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember FleetManagement_GetResult_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(fleet_management::action::FleetManagement_GetResult_Response, status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<fleet_management::action::FleetManagement_Result>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(fleet_management::action::FleetManagement_GetResult_Response, result),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers FleetManagement_GetResult_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(fleet_management::action::FleetManagement_GetResult_Response),
...
{
  return &::fleet_management::action::rosidl_typesupport_introspection_cpp::FleetManagement_GetResult_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fleet_management, action, FleetManagement_GetResult_Response)() {
  return &::fleet_management::action::rosidl_typesupport_introspection_cpp::FleetManagement_GetResult_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers FleetManagement_GetResult_service_members = {
  ...
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<fleet_management::action::FleetManagement_GetResult>()
  nullptr,  // request message
  nullptr  // response message
};
...
get_service_type_support_handle<fleet_management::action::FleetManagement_GetResult>()
{
  // get a handle to the value to be returned
  auto service_type_support =
    &::fleet_management::action::rosidl_typesupport_introspection_cpp::FleetManagement_GetResult_service_type_support_handle;
  // get a non-const and properly typed version of the data void *
  auto service_members = const_cast<::rosidl_typesupport_introspection_cpp::ServiceMembers *>(
    static_cast<const ::rosidl_typesupport_introspection_cpp::ServiceMembers *>(
      service_type_support->data));
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fleet_management, action, FleetManagement_GetResult)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<fleet_management::action::FleetManagement_GetResult>();
}
...
void FleetManagement_FeedbackMessage_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) fleet_management::action::FleetManagement_FeedbackMessage(_init);
}

void FleetManagement_FeedbackMessage_fini_function(void * message_memory)
{
  auto typed_message = static_cast<fleet_management::action::FleetManagement_FeedbackMessage *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember FleetManagement_FeedbackMessage_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(fleet_management::action::FleetManagement_FeedbackMessage, goal_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<fleet_management::action::FleetManagement_Feedback>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(fleet_management::action::FleetManagement_FeedbackMessage, feedback),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers FleetManagement_FeedbackMessage_message_members = {
  ...
  2,  // number of fields
  sizeof(fleet_management::action::FleetManagement_FeedbackMessage),
...
{
  return &::fleet_management::action::rosidl_typesupport_introspection_cpp::FleetManagement_FeedbackMessage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fleet_management, action, FleetManagement_FeedbackMessage)() {
  return &::fleet_management::action::rosidl_typesupport_introspection_cpp::FleetManagement_FeedbackMessage_message_type_support_handle;
}
